...
const NewsLatterBox = () => {
  ...
  const onSubmit = (data) => {
    emailjs
      .send(
        "service_kv7tj2a", // Replace with your EmailJS service ID
        "template_o0lau2j", // Replace with your EmailJS template ID
        {
          email: data.email,
        },
        "GUKMzS3qR1dhO2dn8" // Replace with your EmailJS user ID
      )
      .then(
        (response) => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Stay updated with the latest news and updates. Subscribe to our newsletter by entering your email below.
      </p>
